    ...
    <section class="min-h-[calc(100vh-5rem)] px-6 py-16">
      ...
      <div class="mx-auto max-w-md">
        ...
        <div class="mb-8 text-center">
          ...
          <div
            class="mx-auto flex h-20 w-120 items-center justify-center
                       rounded-xl bg-orange-500
                       text-2xl font-black text-white
                       shadow-lg shadow-orange-500/10 py-10">
            Faça login para acessar o seu painel de hábitos!
          </div>

          <h1 class="mt-5 text-3xl font-black tracking-tight text-gray-400">
            Entre na sua conta
          </h1>

          <p class="mt-2 text-sm text-gray-500">
            Continue sua jornada para uma rotina melhor.
          </p>
        ...
        <form
          ...
          @error('email')
          <p class="mb-4 rounded-lg bg-red-500/20 px-4 py-3 text-sm text-red-500">
            {{ $message }}
          </p>
          @enderror
